...
CS = {
    ...
    # Hole names, in playing order. Every world's twelfth is named after the
    # world itself, so its Czech is already up in the Worlds block above and
    # must not be repeated here — a second entry would just overwrite the first.
    # Garden holes
    "First Steps": "První kroky",
    "The Bars": "Tyče",
    "The Right Angle": "Pravý úhel",
    "Pyramids": "Pyramidy",
    "The Windmill": "Větrný mlýn",
    "Two Passages": "Dva průchody",
    "The Plateau": "Plošina",
    "Garden Path": "Zahradní cestička",
    "The Ditch": "Příkop",
    "Double Waves": "Dvojité vlny",
    "The Horseshoe": "Podkova",
    "Grand Garden": "Velká zahrada",
    # Desert holes
    "Oasis Gate": "Brána oázy",
    "The Funnel": "Nálevka",
    "Blunt Cones": "Tupé kužely",
    "Three Wadis": "Tři vádí",
    "The Step": "Schod",
    "Scorpion Rocks": "Štíří skály",
    "Quicksand": "Tekutý písek",
    "Camel Humps": "Velbloudí hrby",
    "Sidewinder": "Chřestýš",
    "The Oasis": "Oáza",
    "Sandstorm": "Písečná bouře",
    "Desert Crown": "Pouštní koruna",
    # Jungle holes
    "Temple Steps": "Schody k chrámu",
    "The Windows": "Okna",
    "The Cloister": "Křížová chodba",
    "River Crossing": "Přechod řeky",
    "Temple Terrace": "Chrámová terasa",
    "Swinging Vines": "Houpavé liány",
    "The Labyrinth": "Labyrint",
    "Twin Portals": "Dvojice portálů",
    "Serpent Coil": "Hadí smyčka",
    "Jaguar Run": "Jaguáří dráha",
    "Serpent Stair": "Hadí schodiště",
    "Lost Temple": "Ztracený chrám",
    # Ice holes — 12 is Frozen Fjord, the world
    "First Frost": "První mráz",
    "Black Ice": "Náledí",
    "The Crossing": "Křižovatka",
    "The Lightning": "Blesk",
    "Snow Bowl": "Sněhová mísa",
    "The Trench": "Rokle",
    "Frozen Falls": "Zamrzlé vodopády",
    "Crevasse": "Ledovcová trhlina",
    "Two Arms": "Dvě ramena",
    "Twin Peaks": "Dva vrcholy",
    "Avalanche": "Lavina",
    # Neon holes — 12 is Neon Nights, the world
    "Power Up": "Zapnutí",
    "Twin Gates": "Dvojitá brána",
    "The Diamond": "Kosočtverec",
    "Warp Grid": "Warpová mřížka",
    "The Coil": "Cívka",
    "The Flippers": "Pálky",
    "Bus Lanes": "Sběrnice",
    "Data Stream": "Datový tok",
    "Overdrive": "Přetížení",
    "Firewall": "Firewall",
    "The Grid": "Síť",
    # Volcano holes — 12 is Volcano Forge, the world
    "Forge Gate": "Brána výhně",
    "The Cone": "Kužel",
    "Crater Ring": "Kráterový prstenec",
    "Side Vent": "Boční průduch",
    "Magma Chamber": "Magmatický krb",
    "Ash Fall": "Popelový spad",
    "Obsidian Bank": "Obsidiánový svah",
    "The Crucible": "Tavicí kelímek",
    "Lava Flow": "Lávový proud",
    "Forge Terrace": "Terasa výhně",
    "Pyroclast": "Pyroklast",
    # Clockwork holes — 12 is Clockwork Works, the world
    "First Gear": "První převod",
    "Escapement": "Krokový mechanismus",
    "The Governor": "Regulátor",
    "Turntable Row": "Řada otočných talířů",
    "Piston Hall": "Pístová hala",
    "Cuckoo Clock": "Hodiny s kukačkou",
    "Double Cannon": "Dvojité dělo",
    "Optical Illusion": "Optický klam",
    "Ratchet": "Rohatka",
    "Mainspring": "Hlavní pružina",
    "The Great Works": "Velké dílo",
    # Storm holes — 12 is Storm Coast, the world
    "Sea Breeze": "Mořský vánek",
    "Surf Jump": "Skok přes příboj",
    "Gale Alley": "Ulička vichřic",
    "Breakwater": "Vlnolam",
    "Riptide": "Trhavý proud",
    "Lighthouse Point": "Mys s majákem",
    "Squall": "Poryv",
    "Tide Pools": "Přílivové tůně",
    "Storm Surge": "Bouřlivý příboj",
    "Cliff Path": "Cesta po útesu",
    "Maelstrom": "Vír",
    # Cosmos holes
    ...
    # The same in both languages — a bare number, the game's own name, an emoji
    # standing on its own. They are written out rather than left absent so that
    # nothing sits in the catalog in the "needs translation" state, where a real
    # omission would then be indistinguishable from a deliberate one.
    "%lld": "%lld",
    "%lld%%": "%lld%%",
    "MINIGOLF": "MINIGOLF",
    "⛳️": "⛳️",
