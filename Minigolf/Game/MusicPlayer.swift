...
nonisolated final class MusicPlayer: @unchecked Sendable {
    ...
    @objc private func handleInterruption(_ note: Notification) {
        ...
        // Whether the system says the music may pick up again. A call ringing
        // off says yes. Something that took the session over and is still using
        // it — a podcast started from the lock screen over the top of the game —
        // does not, and coming back in underneath it is not what was asked for.
        // Nothing is lost by waiting: `handleForeground` starts the world again
        // the next time the player comes back to the app.
